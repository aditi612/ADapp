...
public class RetrofitPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.retrofit_post);
        ...
        postDataBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameEdt.getText().toString().isEmpty() && jobEdt.getText().toString().isEmpty()) {
                    Toast.makeText(RetrofitPostActivity.this, "Please enter both the values", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                .baseUrl("https://www.reqres.in/api/")
        ...
        call.enqueue(new Callback<DataModal>() {
            ...
            public void onResponse(@NonNull Call<DataModal> call, @NonNull Response<DataModal> response) {
                ...
                Toast.makeText(RetrofitPostActivity.this, "Data added to API", Toast.LENGTH_SHORT).show();
